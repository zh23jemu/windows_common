$result = (repadmin /replsummary) | Out-String
#$result = 'test'
...
$params = @{ 
    ...
    Body = $result
    BodyAsHtml = $false 
    Subject = 'AD Replication Status ' + (get-date -Format 'yyyyMMdd')
    From = 'monitor <monitor.opm@canadiansolar.com>' 
    To = 'billy.zhou@canadiansolar.com'
    Cc = 'wei1.chen@canadiansolar.com'
